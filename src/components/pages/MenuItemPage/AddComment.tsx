  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="mb-6">
        <div className="mb-4 flex w-full max-w-[600px] flex-col gap-4 rounded-lg  rounded-t-lg border border-gray-200 bg-gray-100 px-4 py-2 dark:border-gray-700 dark:bg-gray-800">
